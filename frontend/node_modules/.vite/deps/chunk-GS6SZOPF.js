...
var ICONS = {
  add: async () => (await import("./add-AVKDPZI3.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-C7I7VDRY.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-SLPQAYBT.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-O3KZLJNR.js")).appStoreSvg,
  apple: async () => (await import("./apple-PMUTQC27.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-XHBR4THY.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-IEMVMBVC.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-4FFY32BX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-KSBBNCS5.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6SQA2BVJ.js")).bankSvg,
  browser: async () => (await import("./browser-3WUJXCPZ.js")).browserSvg,
  card: async () => (await import("./card-D2L2YEJH.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-FS63ZDNZ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-RJTGF7ZE.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-2WKCEONM.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-KQLFRJ4G.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-6IVY662K.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-EAJFPFSJ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-AMO24ZKU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-QE34CPC5.js")).clockSvg,
  close: async () => (await import("./close-LCLXVBDC.js")).closeSvg,
  compass: async () => (await import("./compass-VUX2FABG.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-5JIKTMMB.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-HMNOIG45.js")).copySvg,
  cursor: async () => (await import("./cursor-YDYMQNIB.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-7V5LREWO.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-TC7NJZ5K.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-XAQAUG6X.js")).disconnectSvg,
  discord: async () => (await import("./discord-DDXSDN6R.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-ARPH6HLR.js")).etherscanSvg,
  extension: async () => (await import("./extension-LWBNNM7D.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-Y4Z6ELJ4.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-Z3JWSKQV.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-HVULXMC3.js")).farcasterSvg,
  filters: async () => (await import("./filters-GLTMLRP6.js")).filtersSvg,
  github: async () => (await import("./github-O2Z6V5CV.js")).githubSvg,
  google: async () => (await import("./google-OMI4FCPD.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-Z4T7XYZK.js")).helpCircleSvg,
  image: async () => (await import("./image-3P7LRCTP.js")).imageSvg,
  id: async () => (await import("./id-WE6ULHOZ.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-WO57Y3HQ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-F2PMEWCN.js")).lightbulbSvg,
  mail: async () => (await import("./mail-VRWVNPWN.js")).mailSvg,
  mobile: async () => (await import("./mobile-2BNEJESR.js")).mobileSvg,
  more: async () => (await import("./more-3KEGZTTG.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-TGIYYN37.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CZYFFWAW.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RVOIH7TY.js")).offSvg,
  playStore: async () => (await import("./play-store-KEL46KND.js")).playStoreSvg,
  plus: async () => (await import("./plus-4KN4VVIZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-KGVN3UED.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-TP6QI3JB.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-WDOFFDUD.js")).refreshSvg,
  search: async () => (await import("./search-XFW24ZHG.js")).searchSvg,
  send: async () => (await import("./send-NOVNTX6Y.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-EIRYKEFX.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-4V2DEOPJ.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-DEZQFBAG.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-MQUVRDHU.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-WLEFAGUF.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-XUB4KHR3.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-EXNFZENF.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-VUBKSBQR.js")).twitchSvg,
  twitter: async () => (await import("./x-2IEW72D5.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-RHCZDBNV.js")).twitterIconSvg,
  verify: async () => (await import("./verify-WQVE5YV2.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-IIAANO5L.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-4HAIMKZ5.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-GHNTGWT3.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-GHNTGWT3.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-GHNTGWT3.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-NHNXUEWV.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-LNR2EYK2.js")).warningCircleSvg,
  x: async () => (await import("./x-2IEW72D5.js")).xSvg,
  info: async () => (await import("./info-LBL6YH2D.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-Q4G3FRJA.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-WNZISWAT.js")).reownSvg
};
...
//# sourceMappingURL=chunk-GS6SZOPF.js.map
