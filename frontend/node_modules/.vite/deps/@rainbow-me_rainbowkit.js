...
import {
  en_US_default
} from "./chunk-PZZRLTFT.js";
import {
  ens_normalize
} from "./chunk-TAL5Z7XJ.js";
import {
  __assign,
  __rest,
  __spreadArray,
...
} from "./chunk-7SHEIERV.js";
import {
  require_browser
} from "./chunk-OFXWZFRC.js";
import "./chunk-HPZUCVSC.js";
import "./chunk-OV23UUSA.js";
import "./chunk-7TJEI6PY.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-KPYNVEKG.js";
import "./chunk-TTGWCPEH.js";
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-C2ILBICU.js";
import "./chunk-NO6SSSQU.js";
import {
  import_index
} from "./chunk-OC4HUGYJ.js";
import "./chunk-FPO2HGZ3.js";
import {
  http,
  withRetry,
  withTimeout
} from "./chunk-LVHMOHS4.js";
import "./chunk-LZIE4QSY.js";
import {
  Field,
  FpInvertBatch,
  FpSqrtEven,
  ...
  validateBasic,
  wNAF
} from "./chunk-FDT3CKKS.js";
import "./chunk-GQRBCVRM.js";
import {
...
import {
  ...
  utf8ToBytes,
  validateObject
} from "./chunk-U7VPLPGX.js";
import {
  useQuery
} from "./chunk-DN372IBK.js";
import {
  require_jsx_runtime
} from "./chunk-NN2B6Q5S.js";
import {
  clsx_default
} from "./chunk-MKYRKYXK.js";
import {
  require_react_dom
} from "./chunk-CV2V545F.js";
import {
  require_react
} from "./chunk-ZDDD6HS6.js";
import {
  __commonJS,
  __toESM
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-4FAOS3LJ.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-CELDPTEG.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-NP63DHXU.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-IP5AJREP.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-ZUMEPMXT.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-GJSVNUJE.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-6NV7EOWG.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-44JUQ6EW-YYSURDKU.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-PYAO5YD6-OSOGEHHH.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-Y4ZOVFV4-OSSSU7IO.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HRGOJ6VT-5IV42YB3.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-IGGVC6RM-SG6T6XH4.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-XSKAA3MF-GKN5Q4NH.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-KUOB4UAL-6QMJAPN6.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-4WRQ63RX-LO3FOAFV.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-I2K7AIEP-GWEDI46L.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-6VZW6Q3Z-GLHNUSMU.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-N3XOZ4SV-7KK7GN2B.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-IITAPRET-VUC7OTTE.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-3ZQCKCQE-FDHRZKON.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-QUPUGMUF-R2B6Z47Y.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-SSN6SV5E-WZJU7VKB.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-7BUVRNYY-VYIZCDVT.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-HJBN674C-IOSRBLTF.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-JW3WLRKE-W3I6AD33.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-VNNRNXY7-I356DUM4.js")).default;
    default:
      return (await import("./en_US-Y4ZOVFV4-OSSSU7IO.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-YGWMNNVT.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-FROCWRXE.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-WNBXAB2X.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-YYXBO6A4.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-5QE3RLNI.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-RX52KONS.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-QYEEGYN7.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-FX2FFBLU.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-Z5VWIFVF.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-26KVRP2Q.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-HPNVTJYG.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-V7JMAGX2.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-B3LPCL7V.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-FQBREPGZ.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-MFXEQ537.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-RJJZ4OH5.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-X3LHTCS7.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-VRBOOLPM.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-AJX2XBMW.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-HLBHPO27.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-4P2RNI4F.js")).default
};
var monadTestnetIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./monad-4KWC6TSS-26STSBJO.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-IPXTOOKH.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-IS5KSMAR.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-EOZTC3LI.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-PLLRU5OJ.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-H4QK65ZS.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-BXZUBR3W.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-DBYWTR3N.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-I2BTWCDN.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-VE7Z36S4.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-ZFSTARNA.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-4F3FANVC.js")).default
};
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-YAVSNKOG.js")).default;
...
var src2 = async () => (await import("./login-UP3DZBGS-GCPQVJTT.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-7KGHRBG3.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
var src3 = async () => (await import("./connect-UA7M4XW6-IZOZS2BY.js")).default;
...
var src4 = async () => (await import("./create-FASO7PVG-MVN7WXHM.js")).default;
...
var src5 = async () => (await import("./refresh-S4T5V5GX-ROZ4NS7X.js")).default;
...
var src6 = async () => (await import("./scan-4UYSQ56Q-6FO5MA3Q.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-VOK2ALXV.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-BGQACRDL.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-7T23SECU.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-ZKBPQXFW.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-3EBKOQNQ.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-VDJTBGEO.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-SREQGKPV.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-LXIBB4ZA.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-4KACD7MO.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-PYXSMSFP.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-VJUIG22I.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-VJUIG22I.js")).default;
  }
};
...
var baseAccount2 = ({
  ...
  return {
    ...
    rdns: "app.base.account",
    iconUrl: async () => (await import("./baseAccount-44UITRK7-AARTM3T7.js")).default,
    iconAccent: "#0000FF",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-HJ4GCIN4.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-UTL5AV3Z.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-DKHUYGDW.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-EYU5W4XD.js")).default,
